...
public class TestJunit {
	...
	private Driver driver = new Driver(12, "A", "BenBen", "Bibi");
	private Source source = new Source(14, "Beer-Sheva", 050, "Shmulik");
	...
	public void test_Insert_Driver() throws ClassNotFoundException, SQLException {
		manager.insertDriver(false, driver);
		assertEquals(getInfoOf("Driver", 12) , "ID: 12 ,LICENCE KIND: A ,FIRST NAME: BenBen ,LAST NAME: Bibi");
	...
	public void test_Insert_Source() throws ClassNotFoundException, SQLException {
		...
		assertEquals(getInfoOf("Source", 13) , "ID: 14 ,ADDRESS: Beer-Sheva ,CONTACT NAME: Shmulik ,CONTACT PHONE: 050");
	...
	public void test_Insert_Destination() throws ClassNotFoundException, SQLException {
		...
		assertEquals(getInfoOf("Destination", 15) , "ID: 15 ,ADDRESS: Tel-Aviv ,DELIVERY AREA: C ,CONTACT NAME: Saar ,CONTACT PHONE: 050505050");
	...
	public void test_Delete_Truck() throws ClassNotFoundException, SQLException {
		...
		assertEquals(getInfoOf("Truck", 11), null);
	...
	public void test_Delete_Driver() throws ClassNotFoundException, SQLException {
		...
		assertEquals(getInfoOf("Driver", 11), null);
